...
public class GameController {
    ...
    public ResponseEntity<GameScreenData> joinGameAsTeam(@PathVariable long gameId) {
        return ResponseEntity.ok(mockGameScreenData1());
    }
    ...
    public ResponseEntity<PitchOutcomeDetail> getPitchOutcome(@PathVariable long gameId, @RequestBody PitcherChoice body) {
        GameScreenData mockGameScreenData = mockGameScreenData2();
        PitchOutcomeDetail pitchOutcomeDetail = PitchOutcomeDetail.builder()
                                                                  .message("투수 선택: 스트라이크 " +
                                                                                 "투구 결과: 스트라이크 " +
                                                                                 "타자 선택: 스윙 " +
                                                                                 "결과: 안타") // 16 combinations
                                                                  ...
                                                                  .gameScreenData(mockGameScreenData)
                                                                  .build();
    ...
    public ResponseEntity<GameScoreBoard> showScoreBoard(@PathVariable long gameId) {
        return ResponseEntity.ok(getScoreBoardResponse());
    }

    private GameScreenData mockGameScreenData1() {
        return GameScreenData.builder()
                             .homeName("Captain")
                             .awayName("Marvel")
                             .homeScore(1)
                             .awayScore(5)
    ...
    private GameScreenData mockGameScreenData2() {
        return GameScreenData.builder()
                             .homeName("Captain")
                             .awayName("Marvel")
                             .homeScore(1)
    ...
    private GameScoreBoard getScoreBoardResponse() {
        return GameScoreBoard.builder()
    ...
    private GameSummary getGameSummary() {
    ...
    private List<BatterStat> getBatterStatResponses() {
        List<BatterStat> batterStatRespons = new ArrayList<>();
        batterStatRespons.add(BatterStat.builder()
                                        .batterName("김광진")
                                        .atBatCount(1)
                                        .hitCount(1)
                                        .outCount(0)
